              ...
              {experience.map((exp, index) => (
                <div key={exp.id} className="relative pl-6 md:pl-24">
                  ...
                  {index !== experience.length && (
                    <div className="absolute left-1.5 md:left-2 top-8 md:top-10 w-0.5 md:w-1 h-42 md:h-32 bg-gradient-to-b from-blue-400 via-blue-300 to-blue-200" />
                  )}
                  ...
                  <div className="absolute -left-1 md:-left-1.5 top-1 md:top-2">
                    <div className="relative w-5 h-5 md:w-7 md:h-7 flex items-center justify-center">
                      ...
                      <div className="absolute w-3 h-3 md:w-4 md:h-4 bg-white rounded-full" />
                    </div>
                  </div>

                  {/* Content */}
                  <div className="bg-white rounded-2xl border-2 border-blue-100 shadow-md hover:shadow-lg transition-all duration-300 p-4 md:p-6">
                    <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3 sm:gap-0 mb-4">
                      <div>
                        <h3 className="text-lg md:text-xl font-semibold text-gray-900">{exp.role}</h3>
                        <p className="text-blue-600 font-semibold text-base md:text-lg">{exp.company}</p>
                      </div>
                      <div className="text-left md:text-right text-sm text-gray-500 flex flex-row">
                        <div className="bg-blue-50 rounded-lg flex flex-row gap-2 px-3 py-2">
                    ...
                    {exp.description && (
                      <ul className="text-gray-600 mb-4 space-y-2 list-disc list-inside text-sm md:text-base">
